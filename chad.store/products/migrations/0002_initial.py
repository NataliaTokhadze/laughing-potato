...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            name='user',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='favorite_product', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
            model_name='favoriteproduct',
            name='product',
        ...
        migrations.AddField(
            ...
            name='products',
            field=models.ManyToManyField(related_name='products_tags', to='products.product'),
        ),
        migrations.AddField(
            model_name='review',
            name='product',
